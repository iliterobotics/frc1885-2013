#ifndef BHS_AXIS_CAMERA_PARAMS_2_H
#define BHS_AXIS_CAMERA_PARAMS_2_H
 ...
 */
class bhs_AxisCameraParams2 : public ErrorBase
{
public:
...
protected:
	bhs_AxisCameraParams2(const char* ipAddress);
	virtual ~bhs_AxisCameraParams2();
...
protected:
	...
	static int s_ParamTaskFunction(bhs_AxisCameraParams2* thisPtr);
