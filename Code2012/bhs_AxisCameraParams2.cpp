 ...
 */
bhs_AxisCameraParams2::bhs_AxisCameraParams2(const char* ipAddress)
 ...
 * Destructor
 */
bhs_AxisCameraParams2::~bhs_AxisCameraParams2()
{
	m_paramTask.Stop();
 ...
 */
int bhs_AxisCameraParams2::s_ParamTaskFunction(bhs_AxisCameraParams2* thisPtr)
{
...
int bhs_AxisCameraParams2::ParamTaskFunction()
{
 ...
 */
void bhs_AxisCameraParams2::WriteBrightness(int brightness)
{
 ...
 */
int bhs_AxisCameraParams2::GetBrightness()
{
 ...
 */
void bhs_AxisCameraParams2::WriteWhiteBalance(WhiteBalance_t whiteBalance)
{
 ...
 */
bhs_AxisCameraParams2::WhiteBalance_t bhs_AxisCameraParams2::GetWhiteBalance()
{
 ...
 */
void bhs_AxisCameraParams2::WriteColorLevel(int colorLevel)
{
 ...
 */
int bhs_AxisCameraParams2::GetColorLevel()
{
 ...
 */
void bhs_AxisCameraParams2::WriteExposureControl(Exposure_t exposureControl)
{
 ...
 */
bhs_AxisCameraParams2::Exposure_t bhs_AxisCameraParams2::GetExposureControl()
{
 ...
 */
void bhs_AxisCameraParams2::WriteResolution(Resolution_t resolution)
{
 ...
 */
bhs_AxisCameraParams2::Resolution_t bhs_AxisCameraParams2::GetResolution()
{
 ...
 */
void bhs_AxisCameraParams2::WriteExposurePriority(int exposurePriority)
{
	m_exposurePriorityParam->SetValue(exposurePriority);
	semGive(m_paramChangedSem);
}

int bhs_AxisCameraParams2::GetExposurePriority()
{
 ...
 * @param rotation The image from the Rotation_t enum in bhs_AxisCameraParams2 (kRotation_0 or kRotation_180)
 */
void bhs_AxisCameraParams2::WriteRotation(Rotation_t rotation)
{
 ...
 */
bhs_AxisCameraParams2::Rotation_t bhs_AxisCameraParams2::GetRotation()
{
...
void bhs_AxisCameraParams2::WriteCompression(int compression)
{
 ...
 */
int bhs_AxisCameraParams2::GetCompression()
{
 ...
 */
void bhs_AxisCameraParams2::WriteMaxFPS(int maxFPS)
{
 ...
 */
int bhs_AxisCameraParams2::GetMaxFPS()
{
 ...
 */
int bhs_AxisCameraParams2::UpdateCamParam(const char* param)
{
	char *requestString =
 ...
 */
int bhs_AxisCameraParams2::ReadCamParams()
{
	char * requestString =
 ...
 * Used to create a connection to the camera by both bhs_AxisCameraParams2 and AxisCamera.
 ...
 */
int bhs_AxisCameraParams2::CreateCameraSocket(const char *requestString)
{
	int sockAddrSize;
