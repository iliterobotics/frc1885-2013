...
const INT32 bhs_CANJaguar::kControllerRate;
const double bhs_CANJaguar::kApproxBusVoltage;

/**
 * Common initialization code called by all constructors.
 */
void bhs_CANJaguar::Initbhs_CANJaguar()
{
 ...
 */
bhs_CANJaguar::bhs_CANJaguar(UINT8 deviceNumber, ControlMode controlMode)
 ...
 */
void bhs_CANJaguar::Set(float outputValue, UINT8 syncGroup)
{
	UINT32 messageID;
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
void bhs_CANJaguar::PIDWrite(float output)
{
...
UINT8 bhs_CANJaguar::packPercentage(UINT8 *buffer, double value)
{
...
UINT8 bhs_CANJaguar::packFXP8_8(UINT8 *buffer, double value)
{
...
UINT8 bhs_CANJaguar::packFXP16_16(UINT8 *buffer, double value)
{
...
UINT8 bhs_CANJaguar::packINT16(UINT8 *buffer, INT16 value)
{
	*((INT16*)buffer) = swap16(value);
	return sizeof(INT16);
}

UINT8 bhs_CANJaguar::packINT32(UINT8 *buffer, INT32 value)
{
	*((INT32*)buffer) = swap32(value);
	return sizeof(INT32);
}

double bhs_CANJaguar::unpackPercentage(UINT8 *buffer)
{
...
double bhs_CANJaguar::unpackFXP8_8(UINT8 *buffer)
{
	INT16 value = *((INT16*)buffer);
	value = swap16(value);
	return value / 256.0;
...
double bhs_CANJaguar::unpackFXP16_16(UINT8 *buffer)
{
...
INT16 bhs_CANJaguar::unpackINT16(UINT8 *buffer)
{
	INT16 value = *((INT16*)buffer);
	return swap16(value);
}

INT32 bhs_CANJaguar::unpackINT32(UINT8 *buffer)
{
	INT32 value = *((INT32*)buffer);
	return swap32(value);
}
 ...
 */
INT32 bhs_CANJaguar::sendMessage(UINT32 messageID, const UINT8 *data, UINT8 dataSize)
{
 ...
 */
INT32 bhs_CANJaguar::receiveMessage(UINT32 *messageID, UINT8 *data, UINT8 *dataSize, float timeout)
{
	INT32 status = 0;
 ...
 * @param dataSize Specify how much of the data in "data" to send
 */
void bhs_CANJaguar::setTransaction(UINT32 messageID, const UINT8 *data, UINT8 dataSize)
{
	...
	if (GetError().GetCode() != 0) {
		printf("err # %d     dev # %d", (int) GetError().GetCode(), m_deviceNumber);
	}
 ...
 * @param dataSize Indicates how much data was received
 */
void bhs_CANJaguar::getTransaction(UINT32 messageID, UINT8 *data, UINT8 *dataSize)
{
 ...
 */
void bhs_CANJaguar::SetSpeedReference(SpeedReference reference)
{
	UINT8 dataBuffer[8];
 ...
 */
bhs_CANJaguar::SpeedReference bhs_CANJaguar::GetSpeedReference()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
void bhs_CANJaguar::SetPositionReference(PositionReference reference)
{
	UINT8 dataBuffer[8];
 ...
 */
bhs_CANJaguar::PositionReference bhs_CANJaguar::GetPositionReference()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
void bhs_CANJaguar::SetPID(double p, double i, double d)
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
void bhs_CANJaguar::EnableControl(double encoderInitialPosition)
{
	UINT8 dataBuffer[8];
	UINT8 dataSize = 0;
 ...
 */
void bhs_CANJaguar::DisableControl()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize = 0;
 ...
 */
void bhs_CANJaguar::ChangeControlMode(ControlMode controlMode)
{
 ...
 */
bhs_CANJaguar::ControlMode bhs_CANJaguar::GetControlMode()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
float bhs_CANJaguar::GetBusVoltage()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
float bhs_CANJaguar::GetOutputVoltage()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
float bhs_CANJaguar::GetOutputCurrent()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
float bhs_CANJaguar::GetTemperature()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
double bhs_CANJaguar::GetPosition()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
bool bhs_CANJaguar::GetForwardLimitOK()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
bool bhs_CANJaguar::GetReverseLimitOK()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
UINT16 bhs_CANJaguar::GetFaults()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
bool bhs_CANJaguar::GetPowerCycled()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
void bhs_CANJaguar::SetVoltageRampRate(double rampRate)
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
UINT32 bhs_CANJaguar::GetFirmwareVersion()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
UINT8 bhs_CANJaguar::GetHardwareVersion()
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
void bhs_CANJaguar::ConfigNeutralMode(NeutralMode mode)
{
	UINT8 dataBuffer[8];
 ...
 */
void bhs_CANJaguar::ConfigEncoderCodesPerRev(UINT16 codesPerRev)
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
void bhs_CANJaguar::ConfigPotentiometerTurns(UINT16 turns)
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
void bhs_CANJaguar::ConfigSoftPositionLimits(double forwardLimitPosition, double reverseLimitPosition)
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
void bhs_CANJaguar::DisableSoftPositionLimits()
{
	UINT8 dataBuffer[8];
 ...
 */
void bhs_CANJaguar::ConfigMaxOutputVoltage(double voltage)
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
void bhs_CANJaguar::ConfigFaultTime(float faultTime)
{
	UINT8 dataBuffer[8];
	UINT8 dataSize;
 ...
 */
void bhs_CANJaguar::UpdateSyncGroup(UINT8 syncGroup)
{
	sendMessage(CAN_MSGID_API_SYNC, &syncGroup, sizeof(syncGroup));
}


void bhs_CANJaguar::SetExpiration(float timeout)
{
	if (m_safetyHelper) m_safetyHelper->SetExpiration(timeout);
}

float bhs_CANJaguar::GetExpiration()
{
	if (!m_safetyHelper) return 0.0;
	return m_safetyHelper->GetExpiration();
}

bool bhs_CANJaguar::IsAlive()
{
	if (!m_safetyHelper) return false;
	return m_safetyHelper->IsAlive();
}

bool bhs_CANJaguar::IsSafetyEnabled()
{
	if (!m_safetyHelper) return false;
	return m_safetyHelper->IsSafetyEnabled();
}

void bhs_CANJaguar::SetSafetyEnabled(bool enabled)
{
	if (m_safetyHelper) m_safetyHelper->SetSafetyEnabled(enabled);
}

void bhs_CANJaguar::GetDescription(char *desc)
{
	sprintf(desc, "bhs_CANJaguar ID %d", m_deviceNumber);
}
