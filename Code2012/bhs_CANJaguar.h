...
#ifndef BHS_CANJAGUAR_H
#define BHS_CANJAGUAR_H
 ...
 */
class bhs_CANJaguar : public MotorSafety, public PIDOutput, public SpeedController, public ErrorBase
{
public:
	...
	explicit bhs_CANJaguar(UINT8 deviceNumber, ControlMode controlMode = kPercentVbus);
	virtual ~bhs_CANJaguar();
