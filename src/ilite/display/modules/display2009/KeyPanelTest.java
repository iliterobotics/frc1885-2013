...
public class KeyPanelTest extends JPanel
{
  ...
  public KeyPanelTest()
  {
    ...
    Dimension size = new Dimension(847,130);
    ...
    File lock = new File("locked.gif");
    File unlock = new File("unlocked.gif");
    try
    {
      iliteLogo = ImageIO.read(logo);
      locked = ImageIO.read(lock);
      unlocked = ImageIO.read(unlock);
    }
    catch(IOException e)
    {
      e.printStackTrace();
  ...
  public void paint(Graphics g)
  {
    ...
    if(turretLocked==0)
      g.drawImage(unlocked,10,10,null);
    else
      g.drawImage(locked,10,10,null);
  ...
  public void setData(DriverVisualsStruct aaData)
  {
    turretLocked = aaData.mnTurretLocked;
    repaint();
  }
